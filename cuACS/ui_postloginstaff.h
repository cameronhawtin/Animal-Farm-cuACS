...
public:
    ...
    void setupUi(QDialog *PostLoginStaff)
    {
        ...
        AddAnimalButton->setAutoDefault(true);
        ...
        AddClientButton->setAutoDefault(true);
        ...
        QWidget::setTabOrder(AddAnimalButton, ViewAnimalsButton);
        QWidget::setTabOrder(ViewAnimalsButton, generateACMButton);
