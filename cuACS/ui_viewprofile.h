...
public:
    ...
    void setupUi(QDialog *ViewProfile)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(20, 90, 771, 397));
        ...
        QWidget::setTabOrder(patienceLineEdit, sexLineEdit);
        QWidget::setTabOrder(sexLineEdit, homeLineEdit);
        QWidget::setTabOrder(homeLineEdit, attachmentLineEdit);
        QWidget::setTabOrder(attachmentLineEdit, ageLineEdit);
        QWidget::setTabOrder(ageLineEdit, travelLineEdit);
