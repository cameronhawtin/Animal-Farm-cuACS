...
public:
    ...
    void setupUi(QDialog *ViewClients)
    {
        ...
        buttonBox->setGeometry(QRect(750, 450, 341, 32));
        buttonBox->setOrientation(Qt::Horizontal);
        buttonBox->setStandardButtons(QDialogButtonBox::Cancel|QDialogButtonBox::Ok);
        titleLabel = new QLabel(ViewClients);
        titleLabel->setObjectName(QStringLiteral("titleLabel"));
        titleLabel->setGeometry(QRect(420, 40, 581, 41));
        QFont font1;
        ...
        viewClientsListWidget->setGeometry(QRect(20, 40, 281, 431));
        layoutWidget = new QWidget(ViewClients);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setEnabled(true);
        layoutWidget->setGeometry(QRect(320, 100, 251, 331));
        ...
        layoutWidget_4->setGeometry(QRect(840, 100, 251, 331));
        ...
        verticalLayout_6->addWidget(freeTimeLabel);

        freeTimeLineEdit = new QLineEdit(layoutWidget_4);
        freeTimeLineEdit->setObjectName(QStringLiteral("freeTimeLineEdit"));

        verticalLayout_6->addWidget(freeTimeLineEdit);
    ...
    void retranslateUi(QDialog *ViewClients)
    {
        ...
        allergicLabel->setText(QApplication::translate("ViewClients", "Allergies", Q_NULLPTR));
