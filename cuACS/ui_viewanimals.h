...
public:
    ...
    void setupUi(QDialog *ViewAnimals)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(320, 80, 671, 443));
        ...
        QWidget::setTabOrder(aggressionLineEdit, energyLineEdit);
        QWidget::setTabOrder(energyLineEdit, typeLineEdit);
        QWidget::setTabOrder(typeLineEdit, attachmentLineEdit);
        QWidget::setTabOrder(attachmentLineEdit, costLineEdit);
        QWidget::setTabOrder(costLineEdit, breedLineEdit);
        QWidget::setTabOrder(breedLineEdit, obedienceLineEdit);
        QWidget::setTabOrder(obedienceLineEdit, costPerYearLineEdit);
        QWidget::setTabOrder(costPerYearLineEdit, sexLineEdit);
        QWidget::setTabOrder(sexLineEdit, cleanlinessLineEdit);
        QWidget::setTabOrder(cleanlinessLineEdit, isHypoallergenicLineEdit);
        QWidget::setTabOrder(isHypoallergenicLineEdit, ageLineEdit);
        QWidget::setTabOrder(ageLineEdit, childrenComfortLineEdit);
        QWidget::setTabOrder(childrenComfortLineEdit, isCrateTrainedLineEdit);
        QWidget::setTabOrder(isCrateTrainedLineEdit, colourLineEdit);
        QWidget::setTabOrder(colourLineEdit, loudnessLineEdit);
        QWidget::setTabOrder(loudnessLineEdit, isNeuteredLineEdit);
        QWidget::setTabOrder(isNeuteredLineEdit, sizeLineEdit);
        QWidget::setTabOrder(sizeLineEdit, intelligenceLineEdit);
