...
public:
    ...
    void setupUi(QDialog *AddClient)
    {
        ...
        buttonBox->setGeometry(QRect(450, 390, 341, 32));
        ...
        layoutWidget_4->setGeometry(QRect(530, 30, 251, 331));
        ...
        layoutWidget->setGeometry(QRect(10, 30, 251, 332));
        ...
        verticalLayout_2->addWidget(addressLineEdit);
        ...
        layoutWidget_2->setGeometry(QRect(270, 30, 254, 332));
        ...
        verticalLayout_3->addWidget(salaryLabel);

        salaryComboBox = new QComboBox(layoutWidget_2);
        salaryComboBox->setObjectName(QStringLiteral("salaryComboBox"));
        salaryComboBox->setEnabled(true);

        verticalLayout_3->addWidget(salaryComboBox);
        ...
        verticalLayout_3->addWidget(allergicLabel);

        allergicComboBox = new QComboBox(layoutWidget_2);
        allergicComboBox->setObjectName(QStringLiteral("allergicComboBox"));
        allergicComboBox->setEnabled(true);

        verticalLayout_3->addWidget(allergicComboBox);
        ...
        verticalLayout_3->addWidget(childrenLabel);
        ...
        verticalLayout_3->addWidget(childrenLineEdit);
