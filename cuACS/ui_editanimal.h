...
public:
    ...
    void setupUi(QDialog *EditAnimal)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(20, 70, 711, 431));
        ...
        gridLayout_2->addWidget(labelColour_4, 10, 0, 1, 1);
        ...
        gridLayout_2->addWidget(colourComboBox, 11, 0, 1, 1);
        ...
        gridLayout_2->addWidget(energyLabel_2, 0, 2, 1, 1);
        ...
        gridLayout_2->addWidget(energyComboBox, 1, 2, 1, 1);
        ...
        gridLayout_2->addWidget(labelBreed_6, 2, 2, 1, 1);
        ...
        gridLayout_2->addWidget(costPerYearLineEdit, 5, 2, 1, 1);
        ...
        gridLayout_2->addWidget(labelColour_6, 6, 2, 1, 1);
        ...
        gridLayout_2->addLayout(horizontalLayout_20, 11, 2, 1, 1);

        buttonBox = new QDialogButtonBox(EditAnimal);
        buttonBox->setObjectName(QStringLiteral("buttonBox"));
        buttonBox->setEnabled(true);
        buttonBox->setGeometry(QRect(390, 520, 341, 32));
